...
// TÜM FL county'leri statewide centroid layer'da mevcut — CO_NO ile filtrelenir.
const ALL_COUNTIES = {
  ...
  65: "St. Johns", 66: "St. Lucie", 67: "Santa Rosa", 68: "Sarasota", 69: "Seminole", 70: "Sumter",
  71: "Suwannee", 72: "Taylor", 73: "Union", 74: "Volusia", 75: "Wakulla", 76: "Walton", 77: "Washington",
};
...
async function main() {
  ...
  const outName = process.env.OUT || "florida-offmarket.json";
  const outJson = resolve(ROOT, `dashboard/src/data/${outName}`);
