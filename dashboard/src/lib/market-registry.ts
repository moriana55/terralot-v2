...
export function buildMarketRegistry(snapshots: MarketSnapshots): readonly MarketDefinition[] {
  ...
  },
  {
    ...
    nextAction: "157 mektup-atılır lead Supabase'e yüklendi (offmarket_leads, county='Luna'). Sonraki: est_offer/değerleme ekle + 25 APN'yi Luna County kaydıyla örneklem doğrula, sonra kampanya kur.",
  },
  {
    id: "nv-nye",
    name: "Nye County",
  ...
  },
  {
    ...
    state: "Colorado",
    stateCode: "CO",
    counties: ["Costilla", "Las Animas", "Colorado (statewide)"],
    regions: ["San Luis Valley", "Trinidad"],
    status: "pilot",
    ...
    nextAction: "Costilla + Las Animas + statewide açık ArcGIS'ten sahip + POSTA adresli boş arsa lead'leri Supabase'e yüklendi (offmarket_leads). Sonraki: 25 APN'yi county kaydıyla örneklem doğrula, est_offer/değerleme rafine et, kampanya kur.",
  },
  ] as const;
}
