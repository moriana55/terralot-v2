...
// ─────────────────────────────────────────────────────────────────────────────
// ARŞİV — ESKİ "İLAN ÜRETECİ" EKRANI (route DEĞİL, silinmedi).
// İçerik `admin/satis-sayfalari` ekranına taşındı: orada `?id=<parselId>` ile
// aynı editör açılır ve kaynak/fiyatsız/arama filtreleri korunur.
// Bu dosya sadece referans/geri-alma için duruyor; `page.tsx` artık redirect'tir.
//
...
export default async function ArsivIlanUreteciEkrani({ searchParams }: { searchParams: Promise<SP> }) {
