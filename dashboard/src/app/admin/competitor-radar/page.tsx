...
// Derin ilan-bazlı yaşam döngüsü + Recorder doğrulama: /admin/rakip-radar.
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <div className="p-8">
      ...
      <div className="flex items-start justify-between mb-4 gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm max-w-2xl" style={{ color: "var(--muted)" }}>
            ...
            <Link href="/admin/rakip-radar" className="underline" style={{ color: "var(--accent-ink)" }}>Rakip Radar (satış takibi)</Link>.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 mb-4 flex-wrap">
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg" style={{ background: "var(--surface)", border: "1px solid var(--outline)" }}>
          ...
          <select value={comp} onChange={(e) => setComp(e.target.value)} className="bg-transparent outline-none text-xs" style={{ color: "var(--foreground)" }}>
        ...
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg" style={{ background: "var(--surface)", border: "1px solid var(--outline)" }}>
          ...
          <select value={stateF} onChange={(e) => setStateF(e.target.value)} className="bg-transparent outline-none text-xs" style={{ color: "var(--foreground)" }}>
        ...
        <>
          ...
          {data.trackedCount === 0 ? (
            <div className="rounded-xl border border-dashed p-5 text-xs mb-8" style={{ borderColor: "var(--outline)", color: "var(--muted)" }}>
              Henüz izleme geçmişi yok. <Link href="/admin/rakip-radar" className="underline" style={{ color: "var(--accent-ink)" }}>Rakip Radar</Link>&apos;da &quot;Snapshot al &amp; diff&apos;le&quot; ile ilk snapshot alınınca DOM sayaçları başlar; kaybolan ilanlar ertesi koşudan itibaren burada görünür.
            </div>
          ) : (
            <>
