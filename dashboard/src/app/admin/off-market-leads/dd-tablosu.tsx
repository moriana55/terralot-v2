...
// ─────────────────────────────────────────────────────────────────────────────
// DD Tablosu (eski adıyla "Tax Leads") — vergi ihalesi kayıtlarının HAM tablosu
// + tekil parsel için sel/yol due-diligence (DD) kontrolü. "Motive Sahipler"
// sekmesindeki DÜRÜST/filtrelenmiş liste ile aynı `tax_delinquent_properties`
// tablosunu kullanır ama burada filtre yok — ham veri + DD aracı.
// (2026-07-13: /admin/tax-leads sayfası buraya taşındı, sekme haline getirildi.)
// ─────────────────────────────────────────────────────────────────────────────
...
export default function DDTablosu() {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold mb-1">Vergi Borçlusu Lead&apos;ler — DD Tablosu</h1>
          <p className="text-sm" style={{ color: "var(--muted)" }}>
            LGBS ve diğer vergi ihalesi portallarından toplanan ham kayıtlar + sel/yol DD kontrolü
          </p>
        </div>
