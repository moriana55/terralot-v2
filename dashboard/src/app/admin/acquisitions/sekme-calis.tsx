...
// ── "Çalış" sekmesi — Acquisition Pipeline (bu ekranın eski gövdesi) ─────────
// Varsayılan sekme. `?q=` / `?src=` / `?state=` okuması, pipeline/predictor iç
// sekmeleri ve kanban/liste görünümü aynen korundu; sadece dosyaya taşındı.
...
export default function CalisSekmesi() {
  ...
  const printDealSheet = (l: TaxLeadRow) => {
    ...
    <body>
    <div class="hd"><div><div style="font-size:13px;letter-spacing:3px;font-weight:800;color:#0a1a3f">CERBERUS · VEGALAND</div><div style="color:#5b6472;font-size:12px">Off-Market Land Deal Sheet</div></div>
