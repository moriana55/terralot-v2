...
export default async function RakipHaritasi() {
  ...
  const firmalar = [
    ...
    },
    {
      ...
      ilan: `${dl.aktif} aktif · ${dl.satildi} satılmış görünüyor`,
      fiyat: fiyatGuvenilir(dl.ortFiyat) ? dl.ortFiyat : null,
      neden: `Tapuyla eşleşen ilanlarda ortalama çarpan x${kanit.ortKat}. ${kanit.tapuSiniri}`,
    ...
    },
    {
      ...
      ilan: `${rina.aktif} aktif · ${rina.satildi} satılmış görünüyor`,
