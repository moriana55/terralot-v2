...
// ─────────────────────────────────────────────────────────────────────────────
// ARŞİV — eski "/admin/sistem" ekranının kodu. HİÇBİR YERDEN İMPORT EDİLMEZ
// (alt çizgiyle başladığı için route da olmaz); referans olarak saklanıyor.
//
// Neden emekliye ayrıldı (2026-07-29 bilgi mimarisi toparlama):
//   /admin/yontem ile aynı soruyu iki ayrı dille cevaplıyordu ve teklif
//   matematiğinde ÇELİŞİYORDU (burada "değer × %15–25", yontem'de güncel
//   "(piyasa değeri ÷ hedef çarpan) − $2.000"). Tek doğru anlatım yontem.
//
// yontem'e TAŞINANLAR: 2 · Veri Kaynakları · 2b · Comp Kapsama (byStateDetail)
//   · 3 · Scrub Kriterleri · 4 · Eyalet Stratejisi · 6 · Rakip Kıyaslaması.
// TAŞINMAYANLAR (bilerek düşürüldü):
//   • 1 · 5 adımlık döngü  → yontem'in eleme hunisiyle birebir tekrar.
//   • 5 · Teklif & satış matematiği → ESKİ formül, yontem'dekiyle çelişiyor.
//   • 7 · Ne Yaptık / Ne Kaldı → geliştirici panosu, müşteri ekranına ait değil.
// ─────────────────────────────────────────────────────────────────────────────
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-8 p-6 pb-24">
      ...
      <header className="rounded-2xl bg-gradient-to-br from-slate-900 to-slate-700 p-8 text-white">
        <div className="text-xs font-semibold uppercase tracking-widest text-emerald-300">VegaLand · Operasyon Anlatımı</div>
        ...
        <div className="overflow-hidden rounded-xl border border-slate-200">
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-slate-100 text-slate-600">
              ...
              <tr><td className="px-4 py-2 font-semibold">Land Insights</td><td className="px-4 py-2">AI scrub + 5dk değerleme ($5K/yıl)</td><td className="px-4 py-2">VegaLand scrub motorunun rakibi</td></tr>
