    ...
    <div className="p-8">
      ...
      {noData && (
        <div className="text-center py-20 rounded-xl border border-dashed" style={{ borderColor: "var(--outline)", color: "var(--muted)" }}>
          <p className="text-sm font-medium mb-1">County verisi yok</p>
          <p className="text-xs">county_demographics tablosunu doldur (scraper/build-county-demographics.js).</p>
        </div>
      )}
