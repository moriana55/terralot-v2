...
// ─────────────────────────────────────────────────────────────────────────────
// ARŞİV — eski "/admin/apn-sorgula" ekranının kodu. HİÇBİR YERDEN İMPORT EDİLMEZ
...
//   • /admin/apn-dogrula bu ekranın süperkümesi: aynı Mohave ArcGIS sorgusu +
//     aynı parcel-map + ek olarak "bizim kayıtlarımız" karşılaştırması, uyum
//     kontrolü ve TRS bölge özeti.
//   • Burada olup orada olmayan 3 parça (etiketli alan projeksiyonu, ham GIS
//     alan tablosu, Google uydu linki) apn-dogrula'nın "Resmî County Kaydı
//     (canlı)" kartına TAŞINDI.
//   • APN varyant denemesi (tireli/tiresiz/biçimlenmiş) zaten orada
//     `normalizeApnCandidates` ile daha geniş yapılıyor (ayrıca .toUpperCase()).
//
// DİKKAT: aynı klasördeki `parcel-map.tsx` CANLI — apn-dogrula onu
// `import("../apn-sorgula/parcel-map")` ile kullanıyor. Silinmez/taşınmaz.
// ─────────────────────────────────────────────────────────────────────────────
