...
// ─────────────────────────────────────────────────────────────────────────────
// MOD: ANLAŞMA
// Eski `/admin/deal-map` sayfasının gövdesi. Üç varlık tek haritada:
//   • vergi-borçlu deal parselleri (doğrudan Supabase tax_delinquent_properties)
//   • 📅 yaklaşan ihale halkaları (/api/admin/upcoming-sales)
//   • 🏭 megaproje katalizörleri (/api/growth-catalysts)
// Ağır harita bileşeni yerinde bırakıldı: ../deal-map/cerberus-map.
// ─────────────────────────────────────────────────────────────────────────────
...
import type { MapDeal, MapCatalyst, MapSale } from "../deal-map/cerberus-map";

const CerberusMap = dynamic(() => import("../deal-map/cerberus-map"), {
  ssr: false,
...
export default function ModAnlasma() {
