...
// ─────────────────────────────────────────────────────────────────────────────
// MOD: OFF-MARKET · GÖRÜNÜM: VİTRİN (tam ekran)
// Eski `/admin/harita` sayfasının gövdesi — müşteri/yatırımcı sunumu için
// TAM EKRAN vitrin. Ekranın tamamı harita (admin şablonunun üstüne fixed
// overlay), üstte ince şeffaf bar: marka + canlı toplam + eyalet filtre
// çipleri + rakip katmanı + koyu/uydu anahtarı + mod/görünüm seçici.
...
//     (TEK eyalet seçimi + flyCmd ile fly-to-bounds).
// Çoklu eyalet seçimi + istatistik şeridi isteyen analitik görünüm:
...
import ModSecici from "./mod-secici";
...
export default function ModOffmarketVitrin() {
    ...
    <div className="fixed inset-0 z-[80]" style={{ background: "#0b1220" }}>
      ...
      >
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          {/* Mod / görünüm seçici — koyu tema */}
          <ModSecici mod="offmarket" gorunum="vitrin" tema="koyu" />
