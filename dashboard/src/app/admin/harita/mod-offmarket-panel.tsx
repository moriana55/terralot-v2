...
// ─────────────────────────────────────────────────────────────────────────────
// MOD: OFF-MARKET · GÖRÜNÜM: PANEL (analitik)
// Eski `/admin/off-market-harita` sayfasının gövdesi.
// Aktif hedef eyaletlerdeki (lib/offmarket-stats) off-market envanterin TAMAMI
// tek haritada, TEK SİSTEMLE gösterilir.
...
// Vitrin görünümünden farkı: ÇOKLU eyalet seçimi (`activeStates`, `st=` sorgusu),
// `onMeta` ile "haritada çizilen nokta" canlı sayacı ve 4'lü istatistik şeridi.
...
//
// Ağır harita bileşeni yerinde bırakıldı: ../off-market-harita/off-market-map.
// ─────────────────────────────────────────────────────────────────────────────

import { useState } from "react";
import dynamic from "next/dynamic";
import { Loader2, Map as MapIcon } from "lucide-react";
import type { StatePin } from "../off-market-harita/off-market-map";
import { OFFMARKET_STATES, OFFMARKET_STATE_META } from "@/lib/offmarket-stats";
import { useOffmarketStats } from "@/lib/useOffmarketStats";

const OffMarketMap = dynamic(() => import("../off-market-harita/off-market-map"), {
  ssr: false,
  loading: () => (
...
export default function ModOffmarketPanel() {
